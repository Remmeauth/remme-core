...
@pytest.mark.asyncio
async def test_list_blocks_with_ids(mocker, request_):
    """
    Case: get list blocks by ids.
    Expect: list of blocks.
    """
    block_id = ['4d5c30111487e95b80a0240f86ba761cae8d8ccdaae20278e125a0ec7e6bd856'
                '6aafe5f82dee9b71472a65fd48033373137e7be2c8b01596b150e5adfccab314']
    ...
    mock_fetch_block = mocker.patch('remme.shared.router.Router.list_blocks')
    mock_fetch_block.return_value = return_async_value(expected_result)

    result = await list_blocks(request_)

    assert expected_result == result


@pytest.mark.asyncio
@pytest.mark.parametrize('invalid_ids', (0, 1, ['12345'], [0, ], ['12345', 12345],
                                         [True, False], ['12345', 0, 12345, True]))
async def test_list_blocks_with_invalid_ids(request_, invalid_ids):
    """
    Case: list blocks with invalid parameter ids.
...
async def test_list_blocks_with_start(mocker, request_):
    ...
    Expect: list of blocks.
    """
    start = '4d5c30111487e95b80a0240f86ba761cae8d8ccdaae20278e125a0ec7e6bd856' \
            '6aafe5f82dee9b71472a65fd48033373137e7be2c8b01596b150e5adfccab314'
...
async def test_list_blocks_with_invalid_start(request_, invalid_start):
    """
    Case: list blocks with invalid parameter start.
    Expect: header signature is not of a blockchain token type error message.
    """
    request_.params = {
        'start': invalid_start,
...
@pytest.mark.asyncio
async def test_list_blocks_with_limit(mocker, request_):
    """
    Case: get list blocks by limit.
    Expect: list of blocks.
    """
    request_.params = {
        "limit": 1
...
async def test_list_blocks_with_invalid_limit(request_, invalid_limit):
    """
    Case: list blocks with invalid parameter limit.
...
@pytest.mark.asyncio
async def test_list_blocks_with_head(mocker, request_):
    """
    Case: get list blocks by head.
    Expect: list of blocks.
    """
    head = '4d5c30111487e95b80a0240f86ba761cae8d8ccdaae20278e125a0ec7e6bd856' \
           '6aafe5f82dee9b71472a65fd48033373137e7be2c8b01596b150e5adfccab314'
...
async def test_list_blocks_with_invalid_head(request_, invalid_head):
    """
    Case: list blocks with invalid parameter head.
    Expect: given block id is not a valid error message.
    """
    request_.params = {
        'head': invalid_head,
...
async def test_list_blocks_with_reverse(mocker, request_, valid_reverse):
    """
    Case: get list blocks by reverse.
    Expect: list of blocks.
    """
    request_.params = {
