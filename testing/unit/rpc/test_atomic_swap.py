...
async def test_get_atomic_swap_info_with_non_existing_swap_id(mocker, request_):
    ...
    """
    non_existing_swap_id = '133102e41346242476b15a3a7966eb5249271025fc7fb0b37ed3fdb4bcce3806'
    request_.params = {
        'swap_id': non_existing_swap_id,
    }

    expected_error_message = f'Atomic swap with id "{non_existing_swap_id}" not found.'
