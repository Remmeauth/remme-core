...
# Backward compatibility to use more obvious variable name
SETTINGS_KEY_TO_GET_STORAGE_PUBLIC_KEY_BY = SETTINGS_STORAGE_PUB_KEY = 'remme.settings.storage_pub_key'
