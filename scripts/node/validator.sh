...
if [ "$REMME_START_MODE" = "genesis" ]; then
    ...
    sawset proposal create \
        ...
        "sawtooth.validator.block_validation_rules=NofX:1,block_info;XatY:block_info,0;local:0;NofX:1,consensus_account;XatY:consensus_account,1;local:0;NofX:1,obligatory_payment;XatY:obligatory_payment,2;local:0;NofX:1,bet;XatY:bet,2;local:0;" \
