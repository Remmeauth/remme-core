...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='File with a key.')
    ...
    # print(account)
    print(account.SerializeToString())
    ...
    with open(GENESIS_COMMAND_FILE, 'w+') as output_file:
        with open(args.key, 'r') as pub_key:
            ...
            key = PUB_KEY
            output_file.write('sawset proposal create {}={}'.format(key, str(account.SerializeToString())))